 ...
 * @param {import('./public.d.ts').ClickOutsideParameter} param - instructions for `clickoutside` behavior
 * @returns {import('./public.d.ts').ClickOutsideActionReturn}
 */
...
/**
 * @package
 * @param {import('./public.d.ts').ClickOutsideParameter} param
 * @returns {{
 * 	enabled: boolean;
 ...
 * @typedef {import('./public.d.ts').ClickOutsideConfig} ClickOutsideParameters
 */